...
const routes: Routes = [
    {
        path: '', //component: StaffComponent, //matcher : isCheckIn,
        children: [
            { path: '', redirectTo: '/staff/checkin', pathMatch: 'full' }, // { path: ':id/seats', component: SeatsComponent }, // { path: ':id/passengers', component: PassengersComponent },
            {
                path: 'inflight',
                component: StaffComponent, //matcher : isInFlight,
                children: [
    ...
    } // { //     path: 'inflight', //     component: StaffComponent, //     //matcher : isInFlight, //     children: [ //         //{ path: '', redirectTo: '/inflight', pathMatch: 'full' }, //         { path: ':id/seats', component: InFlightComponent } //     ] // }
];
